...
The API is currently hosted at https://dfz5aavjml.execute-api.us-east-1.amazonaws.com/prod/
...
1. cURL (Bash/Terminal)Bashcurl -X POST https://dfz5aavjml.execute-api.us-east-1.amazonaws.com/prod/api/send/ \
...
JavaScript
const url = "https://dfz5aavjml.execute-api.us-east-1.amazonaws.com/prod/api/send/";
